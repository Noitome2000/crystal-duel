...
const files=['index.html','styles.css','draft.css','mobile.css','game.js','rules-engine.js','ai.js','draft.js','self-play.js','training.html','training.css','training.js','training-store.js','learning.js','github-sync.js','assets/icon.svg','assets/icon.ico','vendor/three.min.js','vendor/THREE-LICENSE.txt'];
