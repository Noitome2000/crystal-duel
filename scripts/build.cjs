...
const files=['index.html','styles.css','draft.css','mobile.css','game.js','rules-engine.js','ai.js','draft.js','assets/icon.svg','assets/icon.ico','vendor/three.min.js','vendor/THREE-LICENSE.txt'];
